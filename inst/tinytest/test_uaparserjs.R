...
res <- uaparserjs::ua_parse(NULL, useNA=FALSE)
expect_true(is.null(res$userAgent))
expect_true(is.null(res$ua.patch))
expect_true(is.null(res$os.family))
expect_true(is.null(res$ua.family))
expect_true(is.null(res$ua.major))
expect_true(is.null(res$ua.minor))
expect_true(is.null(res$ua.patch))
expect_true(is.null(res$os.major))
expect_true(is.null(res$os.minor))
expect_true(is.null(res$device.family))
